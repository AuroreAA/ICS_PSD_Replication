...
file_plot = "figures/illustrative_example/data.%s"
...
# colnames(ics_res$scores) <- paste("GINV",  paste0("~rho", "==",ics_res$gen_kurtosis),
...
# save plot to pdf
file_plot = "figures/illustrative_example/data_%s.%s"
...
ics_res <- ICS_generalized(X, S1 = ICS_X_V , S2 = ICS_X_V,
                           ...
                           na.action = na.fail) 
# colnames(ics_res$scores) <- paste("GSVD", paste0("~rho", "==",ics_res$gen_kurtosis),
#                                   colnames(ics_res$scores), sep = "-")
