...
plot_ics <- component_plot(data.frame(X), clusters = clusters, 
                           colors = colors)
# save plot to pdf
file_plot = "figures/OC_HDLSS/data.%s"
...
# save plot to pdf
file_plot = "figures/OC_HDLSS/data_proj_OC.%s"
pdf(sprintf(file_plot,  "pdf"), width = 6.5, height = 5.75)
print(plot_ics)
dev.off()
...
# save plot to pdf
file_plot = "figures/OC_HDLSS/data_X_OC.%s"
pdf(sprintf(file_plot,  "pdf"), width = 6.5, height = 5.75)
print(plot_ics)
dev.off()
...
# save plot to pdf
file_plot = "figures/OC_HDLSS/data_%s_%d.%s"
...
# save plot to pdf
file_plot = "figures/OC_HDLSS/data_%s.%s"
